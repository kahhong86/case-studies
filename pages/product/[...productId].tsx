...
const Product:FunctionComponent<ProductProps> = () => {
    ...
    const [productDesc,setProductDesc] = useState<boolean>(false);
    ...
    return(
        <Layout 
            ...
            description={`Royal Shopping - ${currentPage?.name}`}>
            <Header />
                                ...
                                <div key={index}>
                                    <div className="md:flex py-5">
                                        <div className="flex-auto border-2 border-black mr-10 w-full md:w-4/12 text-center">
                                            <div 
                                                className="w-full h-[300px] md:h-full bg-contain bg-no-repeat bg-center" 
                                                style={{backgroundImage: `url(${assetsUrl +product?.src})`}}></div>
                                        </div>
                                        <div className="flex-auto w-full md:w-8/12">
                                            ...
                                            <div className=" py-5">
                                                ...
                                                <div className="w-full left-0 p-5 md:p-0 fixed bg-blue-400 z-10 bottom-0 md:border-0 md:bg-transparent md:relative md:bottom-auto">
                                                    <div className={`${productDesc?"block":"hidden"} md:block`}>
                                                        <button onClick={clickChangeClose} className="md:hidden absolute top-3 right-3 text-2xl">&#10007;</button>
                                                        <div className="border border-black md:hidden inline-block leading-0 bg-white">
                                                        <div 
                                                            className="w-[100px] h-[100px] md:h-full bg-contain bg-no-repeat bg-center" 
                                                            style={{backgroundImage: `url(${assetsUrl +product?.src})`}}></div>
                                                        </div>
                                                        <span className="w-20 inline-block text-white md:text-black ml-5 md:ml-0">Quantity</span> 
                                                        <div className="inline-block ">
                                                    ...
                                                    <div className="my-4 flex md:block">
                                                        <button className="flex-1 md:flex-none border-red-600 border-2 bg-red-100 p-2 px-5" onClick={clickChange}>
                                                            Add to Cart
                                                        </button>
                                                        <button className="flex-1 md:flex-none bg-red-600 border-2 border-red-600 text-white ml-4 p-2 px-5" onClick={clickChange}>
                                                            Buy Now
                                                        </button>
                                                    </div>
                                                </div>
